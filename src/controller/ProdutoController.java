...
public class ProdutoController extends javax.swing.JFrame {
    ...
    private void adicionaNovoItem(Produto produto ,int quantidade){
        if (verificarEstoque (produto,quantidade)){
            ...
            JOptionPane.showMessageDialog(null," a quantidade indicada nao esta no intervalo valido.");
        }
    }
    ...
    JOptionPane.showMessageDialog(null,"a quantidade indicada nao esta no intervalo vaalido");
    ...
    private void buscarPorId(){
        ...
        if(produto!= null){
            ...
            JOptionPane.showMessageDialog(null,"nenhuma produto encontrado");
        }
        }
    ...
    private void jbLocalizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbLocalizarActionPerformed
        // TODO add your handling code here:
        try {
            if (cliente.getTipo().equals(TipoUsuario.ADMIN)){
                buscarPorId();
            }else{
                buscarPorDescricao();
    ...
    JOptionPane.showMessageDialog(null,"voce nao tem nenhum produto no carrinho.");
}
